...
**Method:**
1. List all workflow skills in `.claude/skills/workflow-*/`
...
2. Target category: `.claude/skills/quality-*/`
...
**Extraction Steps:**
1. Use `create-skill` meta-skill
2. Target category: `.claude/skills/context-*/`
